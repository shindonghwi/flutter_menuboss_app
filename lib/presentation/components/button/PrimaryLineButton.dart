...
class PrimaryLineButton extends HookWidget {
  ...
  /// @author: 2023/09/05 3:13 PM donghwishin
  const PrimaryLineButton.mediumRound8({
    Key? key,
    required this.content,
    required this.isActivated,
    this.onPressed,
  ...
  const PrimaryLineButton.mediumRound100({
    Key? key,
  ...
  /// @author: 2023/09/05 3:13 PM donghwishin
  const PrimaryLineButton.largeRound8({
    Key? key,
    required this.content,
    required this.isActivated,
    this.onPressed,
  ...
  /// @author: 2023/09/05 3:13 PM donghwishin
  const PrimaryLineButton.extraLargeRound8({
    Key? key,
    required this.content,
    required this.isActivated,
    this.onPressed,
  ...
  Widget build(BuildContext context) {
    var textColor = isActivated ? getColorScheme(context).colorPrimary500 : getColorScheme(context).colorGray400;
    ...
    return SizedBox(
      ...
      child: OutlinedButton(
        ...
        style: OutlinedButton.styleFrom(
          side: BorderSide(color: getColorScheme(context).colorPrimary500),
