...
class RemoteFileRepositoryImpl implements RemoteFileRepository {
  ...
  Future<ApiResponse<ResponseFileModel>> postMediaImageUpload(String filePath, {String? folderId}) {
    return _remoteFileApi.postMediaImageUpload(filePath, folderId: folderId);
  }

  @override
  Future<ApiResponse<ResponseFileModel>> postMediaVideoUpload(String filePath, {String? folderId}) {
    return _remoteFileApi.postMediaVideoUpload(filePath, folderId: folderId);
  }

  @override
  Future<ApiResponse<ResponseFileModel>> postProfileImageUpload(String filePath) {
    return _remoteFileApi.postProfileImageUpload(filePath);
  }
}
