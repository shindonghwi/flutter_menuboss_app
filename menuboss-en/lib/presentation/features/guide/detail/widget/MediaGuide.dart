    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Image.asset("packages/menuboss_common/assets/imgs/image_en_guide_media1.png"),
          const SizedBox(height: 12),
          Text(
          ...
          const SizedBox(height: 20),
          Image.asset("packages/menuboss_common/assets/imgs/image_en_guide_media2.png"),
          const SizedBox(height: 32),
          Text(
          ...
          const SizedBox(height: 20),
          Image.asset("packages/menuboss_common/assets/imgs/image_en_guide_media3.png"),
        ],
      ),
    );
  }
